# Problem 3 -- Estimate the parameter values and uncertainties using an MCMC sampler
# Should draw trial steps from curvature matrix drawn in Problem 2
...
for i in range(nstep):
    new_pars=pars+cov@np.random.randn(npars)
    ...
    print('On iteration ',i,' chisq is ',chisq_new,' with step ',cov@np.random.randn(npars),'and parameters',new_pars)
    if i!=0:
